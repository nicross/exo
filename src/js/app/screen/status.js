app.screen.status = (() => {
  ...
  function updateStatus() {
    ...
    const coordinates = {x, y},
      level = content.upgrades.all().reduce((level, upgrade) => level + upgrade.level, 0),
    ...
    root.querySelector('.a-status--metric-level').innerHTML = app.utility.format.number(level)
